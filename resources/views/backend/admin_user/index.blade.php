...
<div class="my-3">
    <a href="{{route('admin.admin_user.create')}}" class="btn btn-primary"><i class="fas fa-plus-circle mr-2"></i>Create new users</a>
</div>
<div class="content">
    <div class="card">
        <div class="card-body">
            
            <table class="table table-striped data" id="admin-users-table">
                <thead>
                    <th>Name</th>
...
@section('scripts')
    <script>
          $(document).ready(function(){
           let table=$('#admin-users-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '/admin/admin_user/datable/ssd',
            order:[[6,"desc"]],
            columns: [
                    { 
                        data: 'name',
